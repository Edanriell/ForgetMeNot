...
//        Preference pref1 = new() { PreferencePrompt = "Shirt Size", PreferenceValue = "Large" };

//        Preference pref2 =
//            new() { PreferencePrompt = "Favorite Music Genre", PreferenceValue = "Jazz" };

//        List<Preference> prefs = new() { pref1, pref2 };

//        var serviceMock = Substitute.For<IPreferenceService>();
//        serviceMock.GetPreferences().Returns(prefs);
...
//        var serviceMock = Substitute.For<IPreferenceService>();
//        serviceMock.GetPreferences().Returns(preferences);
